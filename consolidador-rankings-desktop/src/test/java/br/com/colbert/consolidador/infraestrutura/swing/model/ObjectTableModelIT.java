package br.com.colbert.consolidador.infraestrutura.swing.model;
...
public class ObjectTableModelIT {
    ...
    private static class ExemploTableModel extends ObjectTableModel<Exemplo> {
        ...
        protected List<ObjectTableModelColumn<?>> makeColumns() {
            ObjectTableModelColumn<String> coluna1 = ObjectTableModelColumn.<String> newColumn().withName("Nome").withTheValueOf("nome").type(String.class);
            ObjectTableModelColumn<Integer> coluna2 = ObjectTableModelColumn.<Integer> newColumn().withName("Número").withTheValueOf("numero").type(Integer.class);
