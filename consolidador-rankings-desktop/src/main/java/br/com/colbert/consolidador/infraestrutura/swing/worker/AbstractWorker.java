...
import br.com.colbert.consolidador.ui.comum.mensagens.MessagesView;
...
public abstract class AbstractWorker<T, V> extends SwingWorker<T, V> {
    ...
    /**
     * Obtém o resultado da execução da tarefa. Este método só deve ser chamado após a tarefa ter sido finalizada, pois caso o método {@link #get()} lance
     * alguma exceção, ela será relançada como uma {@link IllegalStateException}.
     * 
