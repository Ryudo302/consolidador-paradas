package br.com.colbert.consolidador.infraestrutura.info;
...
import br.com.colbert.consolidador.infraestrutura.info.TituloAplicacao.Formato;
...
public class ApplicationProperties implements Serializable {
    ...
    public ApplicationProperties() {
        tituloCompleto = new StringBuilder().append(getNomeApp()).append(StringUtils.SPACE).append("v.").append(BUNDLE.getString("app.version")).append(StringUtils.SPACE)
                .append(BUNDLE.getString("app.build")).toString();
    }
