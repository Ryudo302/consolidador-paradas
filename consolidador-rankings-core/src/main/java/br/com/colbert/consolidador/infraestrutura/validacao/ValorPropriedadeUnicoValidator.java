...
/**
 * Validador que verifica se, em uma coleção de itens, determinada propriedade possui valor único entre eles.
 * 
 ...
 */
public class ValorPropriedadeUnicoValidator implements ConstraintValidator<ValorPropriedadeUnico, SortedSet<?>> {
	...
	@Override
	public boolean isValid(SortedSet<?> value, ConstraintValidatorContext context) {
		if (value == null) {
			return true;
		} else {
